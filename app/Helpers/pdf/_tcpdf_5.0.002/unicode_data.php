 ...
 * Putting the combining mark and shadda in the same glyph allows us to avoid the two marks overlapping each other in
 * an illegible manner. second NSM char code=>substitution char
 */
global $diacritics;
$diacritics = [
