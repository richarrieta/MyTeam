...
class HTML2PDF_myPdf extends TCPDF
{
    ...
    public function SetMyFooter($page = false, $date = false, $hour = false, $form = false)
    {
        ...
        $this->_footerParam = ['page' => $page, 'date' => $date, 'hour' => $hour, 'form' => $form];
    }
        ...
        if ($x !== null && $y !== null && $w !== null && $h !== null) {
            ...
            if ($cornerTL || $cornerTR || $cornerBL || $cornerBR) {
                ...
                if ($cornerTR) {
                    ...
                    $path .= sprintf('%.2F %.2F %.2F %.2F %.2F %.2F c ', $xt1, $yt1, $xt2, $yt2, $x2,
                        $y2 + $cornerTR[1]);
                } else {
                ...
                if ($cornerBR) {
                    ...
                    $path .= sprintf('%.2F %.2F %.2F %.2F %.2F %.2F c ', $xt1, $yt1, $xt2, $yt2, $x3 - $cornerBR[0],
                        $y3);
                } else {
                ...
                if ($cornerBL) {
                    ...
                    $path .= sprintf('%.2F %.2F %.2F %.2F %.2F %.2F c ', $xt1, $yt1, $xt2, $yt2, $x4,
                        $y4 - $cornerBL[1]);
                } else {
                ...
                if ($cornerTL) {
                    ...
                    $path .= sprintf('%.2F %.2F %.2F %.2F %.2F %.2F c ', $xt1, $yt1, $xt2, $yt2, $x1 + $cornerTL[0],
                        $y1);
                }
            } else {
                $path .= sprintf('%.2F %.2F m ', $x1, $y1);
    ...
    public function ptTransform(&$x, &$y, $trans = true)
    {
        ...
        list($x, $y) = [($x * $m[0] + $y * $m[2] + $m[4]), ($x * $m[1] + $y * $m[3] + $m[5])];
